...
public class FeedbackRequest extends NubyServiceRequest<SendFeedbackResult> {
    private final String forename;
    private final String message;
    private final String name;
    private final String username;

    public FeedbackRequest(String name, String forename, String username, String message) {
